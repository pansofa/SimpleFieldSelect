  ...
  var e = function () {
    ...
    e.define("select2/dropdown/attachBody", ["jquery", "../utils"], function (f, a) {
      ...
      e.prototype._attachPositioningHandler = function (e, t) {
        ...
        s = this.$container.parentsUntil('article').filter(a.hasScroll);
        s.each(function () {
      ...
      e.prototype._detachPositioningHandler = function (e, t) {
        ...
        this.$container.parentsUntil('article').filter(a.hasScroll).off(n),
        f(window).off(n + " " + r + " " + i)
      },
      e.prototype._positionDropdown = function () {
        ...
        i.bottom = i.top + this.$container.find('.select2-selection').outerHeight(!1);
        var o = {
          height: this.$container.find('.select2-selection').outerHeight(!1)
        };
        o.top = i.top,
