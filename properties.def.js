...
define([], function () {
    ...
    items: {
      ...
      selectionandcontrol: {
        ...
        items: {
          ...
          hideInsightsButton: {
            ref: "props.hideInsightsButton",
            component: "switch",
            type: "boolean",
            label: "Hide Insights button and search",
            defaultValue: false,
            options: [{
                value: true,
                label: "Hide"
          ...
          hideSelectionsTool: {
            ref: "props.hideSelectionsTool",
            component: "switch",
            type: "boolean",
            label: "Hide Selections tool button",
            defaultValue: false,
            options: [{
                value: true,
                label: "Hide"
          ...
          hideSmartSearchButton: {
            ref: "props.hideSmartSearchButton",
            component: "switch",
            type: "boolean",
            label: "Hide Smart Search button",
            defaultValue: false,
            options: [{
                value: true,
                label: "Hide"
  ...
  function findVariableName(listobject, props) {
    ...
    if (debug)
      console.log('Var type:' + typeof props.variableName);
    ...
    if (debug) {
      ...
      console.log(props);
      console.log(listobject.qDef.qFieldDefs[0]);
    }
  ...
  function findVariableValue(data) {
    ...
    if (debug) {
      console.log('variable name is ' + data.props.variableName);
      console.log('variable expression: ' + data.variableValue.qStringExpression);
      console.log(data);
    }
  }
  return {
        ...
        items: {
          ...
          VisualizationType: {
            ...
            options: [{
                ...
                value: "btn",
                label: "Standard HTML button"
              }, {
                value: "radio",
                label: "Standard HTML radio button"
              }, {
                value: "input",
                label: "Standard HTML5 input (numbers, text, sliders)"
              }, {
                value: "select2",
                label: "Select2 dropdown"
              }, {
                value: "luiswitch",
                label: "Qlik Switch"
              }, {
                ...
                value: "luiradio",
                label: "Qlik Radio button"
              }, {
                value: "txtonly",
                label: "Only a textarea"
              }, {
                value: "searchonly",
                label: "Only search and select"
              }
          ...
          Visualization: {
            ...
            items: {
              ...
              fixedfontsize: {
                ...
                defaultValue: false,
                show: function (data) {
                  return !data.props.responsivefontsize;
                }
              },
              fixedfontsizevalue: {
                type: "number",
                ...
                max: 1000,
                show: function (data) {
                  return data.props.fixedfontsize;
                }
              },
              responsivefontsize: {
              ...
              responsivefonttype: {
                ...
                options: [{
                    value: "vw",
                    label: "% of viewport width"
                  }, {
                    value: "vh",
                    label: "% of viewport height"
                  }, {
                    value: "vmin",
                    label: "whichever is smaller"
                  }, {
                    value: "vmax",
              ...
              elHeight: {
                ref: "props.elHeight",
                type: "string",
                label: "Element special height (10% or 50px or 5rem or calc(50% - 20px))",
                defaultValue: '',
                expression: "optional"
              },
              elWidth: {
                ...
                items: {
                  ...
                  rightclickmenuinfo: {
                    ...
                    items: {
                      aboutt: {
                        component: "text",
                        label: "Select action items for the context menu:"
                      }
                    }
                  },
                  rightclikcmenu_selall: {
                    ref: "props.rightclikcmenu_selall",
                    type: "boolean",
                    label: "Select all",
                    defaultValue: true
                  },
                  rightclikcmenu_clear: {
                    ref: "props.rightclikcmenu_clear",
                    type: "boolean",
                    label: "Clear selections",
                    defaultValue: true
                  },
                  rightclikcmenu_reverse: {
                    ref: "props.rightclikcmenu_reverse",
                    type: "boolean",
                    label: "Reverse selections",
                    defaultValue: true
                  },
                  rightclikcmenu_possible: {
                    ref: "props.rightclikcmenu_possible",
                    type: "boolean",
                    label: "Select possible",
                    defaultValue: true
                  },
                  rightclikcmenu_random: {
                    ref: "props.rightclikcmenu_random",
                    type: "boolean",
                    label: "Select randomly (why? well...)",
                    defaultValue: false
                  },
                  rightclikcmenu_defaults: {
                    ref: "props.rightclikcmenu_defaults",
                    type: "boolean",
                    label: "Select default values",
                    defaultValue: true
                  },
                  rightclikcmenu_copy: {
                    ref: "props.rightclikcmenu_copy",
                    type: "boolean",
